...
export default function BenefitsScreen() {
  ...
  const vouchers = [
    {
      id: 1,
      title: "Monthly Free Sip",
      desc: "1 FREE Iced Americano or Iced Lemon Tea at the start of every month!",
    },
    {
      id: 2,
      title: "Weekly Free Upsize",
      desc: "Enjoy 1x FREE Upsize every week to upgrade from Regular to Large for free!",
    }
  ];

  return (
    // UDAH BUKAN SafeAreaView LAGI BIAR COKLATNYA MENTOK ATAS
    <View style={styles.container}>
      ...
      >
        ...
        {/* 3. VOUCHER LIST (Pake efek gerigi) */}
          ...
          {vouchers.map((v) => (
            <View key={v.id} style={styles.voucherCard}>
              ...
              <View style={styles.voucherContent}>
                ...
                {/* Tombol claim gw arahin balik aja biar aman */}
                <TouchableOpacity style={styles.claimBtn} onPress={() => router.push('/profile')}>
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingBottom: 20,
    // PADDING TOP PINDAH KE SINI BIAR MENTOK ATAS
  ...
  scrollContent: {
    flexGrow: 1, 
    paddingTop: 10,
    paddingBottom: 150, // <-- UDAH GW GEDEIN BIAR LEGA SCROLLNYA
  },
  ...
  card: {
    ...
    padding: 22,
    paddingBottom: 30, 
    marginBottom: 35, // Jarak ke Voucher
    elevation: 5,
    shadowColor: "#000",
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.2,
  ...
  dot: {
    ...
    height: 18,
    borderRadius: 9,
    backgroundColor: '#E5D9C6', // Harus sama kaya background utama layar
    marginLeft: -18, 
  },
