import { Ionicons } from '@expo/vector-icons'; // I added Ionicons for the back arrow
import { useLocalSearchParams, useRouter } from 'expo-router'; // I added useRouter here
...
export default function RincianScreen() {
  ...
  const router = useRouter(); // I initialized the router here
  ...
  // variabel baru buat ngecek menu yang cuma bisa dingin
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        {!isDessert && (
          <>
            {/* bagian suhu cuma dirender kalau bukan isColdOnly */}
            {!isColdOnly && (
              <>
